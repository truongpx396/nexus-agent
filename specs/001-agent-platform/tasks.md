...
- **US4 (P2)**: Foundational + US1 (meters/observes the loop); eval gate is independent. Its fork-based trajectory cases (T092n) additionally need the `fork` primitive of US7/T128-class work, and its online scorer (T092k) needs the content-access machinery of T088b — both extend a Foundational gate that already blocks without them
